...
class CustomeDataSet(Dataset):
    def __init__(self, transform=None, size=(768, 768)):
        # Recuperando dados com dataframe --> Pelo visto é a melhor forma ...
        self.df = pd.read_sql("SELECT * FROM dados_table", con=create_engine(Settings().DATABASE_TRAIN_URL) )
        self.traindata_url = Settings().DATABASE_TRAIN_URL # path da pasta com os dados
    ...
    def __getitem__(self, index):
        ...
        return caption, img_root, img_mask